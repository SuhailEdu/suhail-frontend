...
export default function HomeOurMessageSection() {
    ...
    return (
        <div className="mx-auto my-12  max-w-6xl">
            <h2 className="mb-4 text-lg sm:text-xl md:text-3xl  lg:text-6xl text-center tracking-tight font-extrabold text-gray-900 dark:text-white">نساهم
            ...
            hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
                <div className="flex flex-col justify-between p-4 leading-normal">
                    <h5 className="mb-4 text-lg md:text-xl  lg:text-4xl font-bold tracking-tight text-gray-900 dark:text-white">مهمتنا : تعليم
                        بجودة أفضل</h5>
                    <p className="mb-3 font-normal text-md md:text-2xl text-gray-700 dark:text-gray-400">
