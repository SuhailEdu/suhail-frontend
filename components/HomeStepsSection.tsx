        ...
        <section className="bg-gray-50 py-12 sm:py-16 lg:py-20 xl:py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    <p className="text-sm font-bold uppercase  text-gray-700">كيف أنشئ أختبار الكتروني</p>
                    <h2 className="mt-6 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">أنشئ
                        اختبارك الألكتروني في دقائق</h2>
                    <p className="mx-auto mt-4 max-w-2xl text-lg font-normal text-gray-700 lg:text-xl lg:leading-8">أنشئ
                        اختبارك الألكتروني في دقائق</p>
                </div>
                <ul className="mx-auto mt-12 grid max-w-md grid-cols-1 gap-10 sm:mt-16 lg:mt-20 lg:max-w-5xl lg:grid-cols-4">
                    <li className="flex-start group relative flex lg:flex-col">
                        ...
                        <div className="ml-6 lg:ml-0 lg:mt-10">
                            <h3
                                className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">أضف
                                أسئلتك الخاصة</h3>
                            <h4 className="mt-2 text-base text-gray-700">قم بإنشاء أسئلة اختبار متنوعة، ببساطة
                                وسرعة.</h4>
                        </div>
                    </li>
                    <li className="flex-start group relative flex lg:flex-col">
                        ...
                        <div className="ml-6 lg:ml-0 lg:mt-10">
                            <h3
                                className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">أظبط
                                أعدادات الأختبار</h3>
                            <h4 className="mt-2 text-base text-gray-700">حدد وقت الاختبار ومدة كل سؤال والإعدادات الأخرى
                                التي تتناسب مع متطلباتك التعليمية.</h4>
                        </div>
                    </li>
                    <li className="flex-start group relative flex lg:flex-col">
                        {/*<span*/}
                        ...
                        <div className="ml-6 lg:ml-0 lg:mt-10">
                            <h3
                                className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">أدعو
                                طلابك للاختبار</h3>
                            <h4 className="mt-2 text-base text-gray-700">يمكن للطلاب الوصول إلى الاختبار باستخدام
                                حساباتهم والإجابة على الأسئلة بكل يسر</h4>
                        </div>
                    </li>
                    <li className="flex-start group relative flex lg:flex-col">
                        <div
                        ...
                        <div className="ml-6 lg:ml-0 lg:mt-10">
                            <h3
                                className="text-xl font-bold text-gray-900 before:mb-2 before:block before:font-mono before:text-sm before:text-gray-500">احصل
                                على نتائج الاختبار</h3>
                            <h4 className="mt-2 text-base text-gray-700">نوفر لك امكانية حساب درجات الاختبار
                                تلقائيا</h4>
                        </div>
                    </li>
                </ul>
