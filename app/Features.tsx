...
export default async function Features() {
  ...
  <div className="container max-w-7xl mb-20 mx-auto px-6 md:px-12 xl:px-6">
    <div className="md:w-2/3 lg:w-1/2">
      ...
      <p className="text-gray-600 dark:text-gray-300">مع سهيل، يمكنك إضافة اختبارات جديدة بسهولة ويسر، دون الحاجة إلى مساعدة تقنية، مما يوفر لك الوقت والجهد ويزيد من كفاءة عملية التقييم</p>
    </div>
    <div
